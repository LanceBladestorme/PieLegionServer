...
class BattleCalculatorAI:
    ...
    def __initRound(self):
        ...
        for special in specials:
            ...
            if npc_track == NPC_TOONS_HIT:
				...
				cogsMiss = 1
            elif npc_track == NPC_TOONS_MISS:
                BattleCalculatorAI.toonsAlwaysMiss = 1
                toonsMiss = 1
            elif npc_track == NPC_COGS_HIT:
                BattleCalculatorAI.suitAlwaysHit = 1
                cogsHit = 1
        ...
        self.__initTraps()
        self.successfulLures = {}
        return (toonsHit, cogsMiss, toonsMiss, cogsHit)
    ...
    def calculateRound(self):
        ...
        toonsHit, cogsMiss, toonsMiss, cogsHit = self.__initRound()
        for suit in self.battle.activeSuits:
            if suit.isGenerated():
        ...
        if toonsMiss == 1:
            BattleCalculatorAI.toonsAlwaysMiss = 0
        if cogsHit == 1:
            BattleCalculatorAI.suitsAlwaysHit = 0
        if self.notify.getDebug():
