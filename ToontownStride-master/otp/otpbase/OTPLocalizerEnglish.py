...
TeleportGreeting = 'Hey Scrublord %s!'
...
CRBootedReasons = {100: 'You have been disconnected because someone else just logged in using your account on another computer.',
 ...
 105: 'Toontown Pie Legion is now temporarily closed for maintenance. Everyone who was playing has been disconnected from the game.',
 124: 'Your installed files are out of date!  Use the official launcher to download the newest version, or contact Clover or Ziggy if the problem persists.',
...
SCMenuCJBattle = 'Detective Lucky'
...
SCMenuFriendlyILike = 'Stream Memes'
...
EmoteWhispers = ['%s waves.',
 ...
 '%s is crying.',
 '%s is delighted.',
 '%s is really triggered.',
 '%s is laughing.',
 '%s is Oh @#$%! You dead, bruh! RUN FOR YOUR LIFE!!!!']
EmoteFuncDict = {'Wave': 0,
 'Turned Up': 1,
 'Sad': 2,
 'Slightly Triggered': 3,
 'Sleepy': 4,
 'Shrug': 5,
 'Dance': 6,
 'Think': 7,
...
SuitFaceoffTaunts = {'b': ["Sucks to be near me!",
       "I'm only doing this for attention",
       "I'm only doing this for attention",
       "I'm only doing this for attention",
       "I'll quit in 3 months, I swear!",
       "I'll quit in 3 months, I swear!",
       "I'll quit in 3 months, I swear!",
       "Sucks to be near me!",
       "Sucks to be near me!",
       ...
       "I'm only doing this for attention",
       "I'll quit in 3 months, I swear!"],
 'm': ["You'll never believe what this person in the chat said!",
       '/ban -insert username here-',
       'SPAM SPAM SPAM SPAM SPAM SPAM SPAM',
       "!shimrambles",
       'Luke, I am you Shimotu!',
       "In the Shim justice system, Shim related offenses are considered especially heinous ... DUN DUN",
       "Frankly, Ma'am, I don't give a Shim",
       "One time at Shim camp, I shoved a whole cream pie down a cannon.",
       "Hey, it's Scarce here!"],
 'ms': ["Time to get shimmy with it!",
        "Time to get shimmy with it!",
        'Good luck Shimmying your way out of here!',
        "Good luck Shimmying your way out of here!",
        'Good luck Shimmying your way out of here!',
        "Time to get shimmy with it!",
        "Your about to be out-shimmed!",
        "Your about to be out-shimmed!",
        "Your about to be out-shimmed!",
        "Your about to be out-shimmed!",
        "Your about to be out-shimmed!"],
 'hh': ["STOP WITH THE PUNS!",
        "This is a pun-free zone!",
        "No puns allowed!",
        "Toon, I heard that pun...",
        "I'll have your scrub head for this.",
        'Heads up! Scrubs out!',
        "Looks like you've got a scrub for trouble.",
        'Headed my way, scrub?',
        'Do not even think of word play around me, scrub!',
        'You are going to have such a headache, scrub.',
        "This is a pun-free zone!"],
 'tbc': ["Watch out, there a Jimmy's at work here",
         'You can call me NOT Jimmy',
         'Do your balls! Do your balls!',
         "Have you tried Loopy's Balls?",
         "Beware of Fat Jimmy",
         "Don't ask what the G stands for!",
         "Would you like side of Jimmy with those meet balls?",
 ...
 'cr': ['SPAM RAID!',
        ...
        "I'll slide with the spam",
        "Want to spam? Cough up the beans first...",
        "I'll enter the giveaway for Spam!",
        'SPAM RAID!',
        "SPAM I AM!",
        'SPAM SPAM SPAM SPAM SPAM',
        "I'll slide with the spam"],
 ...
 'f': ["!Brainpower",
       ...
       "I will get my mod status back, Starting with YOU!",
       'Really?! It was just one mistake!',
       "www.twitch.tv/mrpieman10",
       "O-oooooooooo AAAAE-A-A-I-A-U- JO-oooooooooooo",
       "O-oooooooooo AAAAE-A-A-I-A-U- JO-oooooooooooo",
       'O-oooooooooo AAAAE-A-A-I-A-U- JO-oooooooooooo',
       "I will get my mod status back, Starting with YOU!",
       "BRAINPOWER!!!!!!"],
 'p': ["Why don't you do a face reveal?",
       "No, I'm not doing a door giveaway!",
       "Uxie!!!!!!!",
       "You're a scrub!",
       "I actually did do a face reveal lol",
       "Let's go watch Teen Beach Movie with the trio!",
       "No, I'm not doing a door giveaway!",
       'Uxie!!!!!!!',
       "I'm not a sellout!!!",
       'Uxie!!!!!!!',
       "I'm lowkey so low key training right now!"],
 'ym': ["wwww.twitch.tv/mrpieman10",
        "I'm not drunk! -Collapses onto keyboard-",
        'Why does my name sound so weird?',
        'Ziggy, go kill yourself',
        "Wait... someone... cares about Ziggy in the Pie Legion?",
        "I haven't been wrong yet.",
        "Losers",
        '-INSERT INSULT ABOUT ZIGGY HERE-',
        "Wait... Ziggy said something useful?!",
        "Losers",
        'Ziggy, go kill yourself'],
 'mm': ["Got the time?",
        "You have a problem? Tell the other mods!",
        'I can be a mod even if I do not have Pokemon!',
        "www.twitch.tv/mrpieman10",
        'Wait... what did I miss?',
        "I'm willing to step down as mod if someone really wants it",
        'I can be a mod even if I do not have Pokemon!',
        'I can be a mod even if I do not have Pokemon!',
        'I can be a mod even if I do not have Pokemon!',
        "You have a problem? Tell the other mods!",
        ...
        "You have a problem? Tell the other mods!",
        "www.twitch.tv/mrpieman10"],
 'ds': ["You may fizzle from this fight.",
        "Watch out or I'll have you a Coke hold!",
        "Don't mess with me or I'll pop a few Mentos!",
        "I got enough energy for this battle",
        "Next time you choose Pepsi, remember what it did to Michael Jackson!",
        'I might have to make a few cutbacks.',
        "I'm friends with Santa! Don't make me put you on the naughty list!",
        'When I first met Coke, I got aHEAD in life!'],
 'cc': ["I got your message! Hang on!",
        'I knew I was right. Called it!',
        "I'm freakin 18! How am I underage for streaming?",
        '!shimrambles',
        "You have reached rambling services. Please press 1 for your rambling desires to be fulfilled!",
        ...
        "You have reached rambling services. Please press 1 for your rambling desires to be fulfilled!",
        "You have reached rambling services. Please press 1 for your rambling desires to be fulfilled!"],
 'tm': ["You have reached rambling services. Please press 1 for your rambling desires to be fulfilled!",
        "You have reached rambling services. Please press 1 for your rambling desires to be fulfilled!",
        "You will be buying our shirts, correct?",
        "You will be buying our shirts, correct?",
        'This a bad time? I can wait... -power goes out-',
        "This call is shim-tastic, but i must hang up",
        "This call is shim-tastic, but i must hang up",
        'I have some costly items for you today.',
        'Too bad for you - I make house calls.',
        "Can they join the call, Nick?",
        "!shimrambles"],
 'nd': ['In my opinion, your name is Shimworthy',
        "I hope you don't mind if I chance your name to Shim.",
        "Time to drop the shim",
        "Let's hurry, I'm having lunch with 'Mr. Shimmywood.'",
        "Have I mentioned I know 'The Chat Mingler?'",
        "You'll never forget me. I'm THE meme.",
        'I know all the Shimtastic people to bring you down.',
        "I think I'll just Shimmy on in.",
        "I'm in the mood to drop some Shim.",
        "You name it, I've Shim it."],
 'gh': ['Shim it there, Toon.',
        "Let's shimmy on it.",
        "I'm going to enjoy this.",
        "You'll notice I have a very firm grip.",
         "I've handled bigger situations than this!",
        "Let's get right to the Shimteresting details!",
        "Off handedly I'd say, you're in Shimbles.",
        "You'll find I'm a Shim!",
        'I can be quite Shim-like.',
        "I'm a very Shim obsessed kinda guy.",
        'Would you like some shim-me-downs?',
        'Let me show you some of my Shimmyiwork.',
        "I think the handwriting is on Shim's forehead.",
        "I'll gladly handle your Shim busicness for you."],
 'sc': ["I'll gamble YOU"
        "I think I have a problem",
        "#VegasOfToontownGoneWrong",
        "I'll eventually strike it out big!",
        "Let's gamble this battle!",
        "Let's gamble this battle!",
        "Let's gamble this battle!",
        "I'll eventually strike it out big!",
        "#VegasOfToontownGoneWrong",
        ...
        "I think I have a problem"],
 'pp': ["Let me just see those tokens, toon..",
        "Someone is starting to gather a mini token fortune",
        "In just a pinch, your tokens will be gone",
        "In just a pinch, your tokens will be gone",
        "In just a pinch, your tokens will be gone",
        'Let me add my two tokens to the subject.',
        "I've been asked to pinch-hit.",
        "Pinch me a better idea than saving?",
        "Pinch me a better idea than saving?",
        'What are you saving for?'],
 'tw': ["No! They are mine, All mine!",
        "Don't take my precious!",
        "No! They are mine, All mine!",
        'Is this the best deal you can offer?',
        "I'll never spend my hard earned tokens!",
        "Don't take my precious!",
        "No! They are mine, All mine!",
        "No! They are mine, All mine!",
        "I'll never spend my hard earned tokens!",
        "I'll never spend my hard earned tokens!",
        "I'll never spend my hard earned tokens!"],
 'bc': ["I enjoy subtracting Toons' tokens!",
        "Lets count your tokens!",
        "You are running low on tokens, Toon.",
        'Your token amount is OVER 9000?!?!?!',
        'I count this another addition to my token collection!',
        "Lets count your tokens!",
        "Lets count your tokens!",
        "You are running low on tokens, Toon.",
        "You are running low on tokens, Toon.",
        'I count this another addition to my token collection!',
		"I count this anoother addition to my token collection!"],
 'bf': ["I'll quit in 3 months, I swear!",
       "I'll quit in 3 months, I swear!",
       "I'll quit in 3 months, I swear!",
       "I'll quit in 3 months, I swear!",
       "If i can't quit, I sure can make you quit!",
       "If i can't quit, I sure can make you quit!",
       "If i can't quit, I sure can make you quit!",
       "If i can't quit, I sure can make you quit!",
       "If i can't quit, I sure can make you quit!",
       "I'll quit in 3 months, I swear!"],
 'tf': ["Have you ever looked in the mirror and thought what's my name backwards?",
        "Have you ever looked in the mirror and thought what's my name backwards?",
        "Have you ever looked in the mirror and thought what's my name backwards?",
        "Have you ever looked in the mirror and thought what's my name backwards?",
        "Have you ever looked in the mirror and thought what's my name backwards?",
        "Have you ever looked in the mirror and thought what's my name backwards?",
        ...
        "Have you ever looked in the mirror and thought what's my name backwards?",
        "Have you ever looked in the mirror and thought what's my name backwards?"],
 'dt': ["You can never ban me! Mwah ha ha ha!",
        'I have enough IDs to last forever!',
        "You can never ban me! Mwah ha ha ha!",
        "You can never ban me! Mwah ha ha ha!",
        "You can never ban me! Mwah ha ha ha!",
        "You can never ban me! Mwah ha ha ha!",
        'I have enough IDs to last forever!',
 ...
 'ac': ["I'm 51. not 9!",
        ...
        "I'm 51. not 9!",
        "I'm 51. not 9!",
        "You are in for a world of gold",
        "You are in for a world of gold",
        "You are in for a world of gold",
        "You are in for a world of gold",
        "You are in for a world of gold",
...
SpeedChatStaticTextToontown = {100: 'Hi!',
 ...
 102: 'Hiya!',
 103: 'Hey, scrub!',
 104: 'Hey, toons of the world!',
 105: 'Hi peeps!',
 106: 'Welcome to the Pie Legion!',
 107: "Wat up?",
 108: 'How are you doing, scrub?',
 109: 'You there, scrub?',
 200: 'Bye!',
 201: 'Later!',
 202: 'GTG!',
 ...
 205: 'Good luck!',
 206: "BRB!",
 207: 'Looking for someone to raid.',
 208: "Will be back later!",
 ...
 505: 'Good teamwork!',
 506: 'That was fun!',
 507: 'Accept my friend request, please!',
 508: "Let's team up!",
 ...
 600: 'Like the outfit!',
 601: 'I like Brainpower spammed constantly',
 602: 'Noice!',
 ...
 805: 'Sorry, I crashed!',
 806: 'Sorry, but no... just no...',
 807: "Sorry, I can't.",
 808: "Sorry, but I'm feeling edgy today",
 809: "Speak Engrish!",
 ...
 1006: 'Follow me.',
 1007: 'Wait for me!',
 1008: "I got a friend coming.",
 1009: "Let's find other Toons.",
 1010: 'Wait here.',
 1011: 'Wait a minute.',
 1012: 'Meet here.',
 1013: 'Check out my crib, scrub!',
 ...
 1501: "Let's use trap! ... Oh  wait! Nick is lureless",
 1502: "Let's use lure!",
 ...
 1554: "Let's all use common sense! Please!",
 1555: 'WRONG COG YOU SCRUB!!!',
 1556: 'Go for the cog that most looks like Shim.',
 1557: 'You go first!',
 1558: "Don't start goin ham with them high gags please!",
...
AccessToString = {
 200: '\x01amaranth\x01Pie Legion Lieutenant\x02',
 300: '\x01caribbeanGreen\x01Pie Legion Captain\x02',
 400: '\x01amber\x01Pie Legion Major\x02',
 500: '\x01androidGreen\x01Pie Legion General\x02',
 600: '\x01cobalt\x01Pie Legion Overlord\x02',
 700: '\x01azure\x01Server Host\x02'
}